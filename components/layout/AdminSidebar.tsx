...
export function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile vertical nav */}
      <div className="border-b border-gray-200 bg-amber-50/30 px-4 py-3 lg:hidden">
        <div className="rounded-md bg-amber-100 px-3 py-1.5 text-center text-xs font-semibold text-amber-800 uppercase tracking-wider mb-3">
          Admin Panel
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            href="/dashboard"
            className="rounded-full bg-white px-3 py-1.5 text-xs font-medium text-gray-500 hover:bg-gray-100"
          >
            Back to Dashboard
          </Link>
        </div>
